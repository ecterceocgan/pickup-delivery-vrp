...
class RouteNode(NodeMixin):
    def __init__(self, name, trip_id=None, pickup=None, loc=(0, 0), route_opt=None,
                 trip_time=0, parent=None):
        ...
        # dictionary of trips storing information about who can be picked up/dropped off
        self.route_options = route_opt
